...
public class CheatSheetScreen extends Screen {
    ...
    public CheatSheetScreen(Screen parent) {
        super(Component.literal("Keys4Macros Cheat Sheet"));
    ...
    public void render(@Nonnull PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        drawCenteredString(pPoseStack, this.font, Component.literal("For any additional help join the discord : ").append(Component.literal("https://discord.gg/rzzd76c").withStyle(style -> style.withClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, "https://discord.gg/rzzd76c")))), this.width / 2, this.height / 2 + 40, 16777215);
